...
def roll_d20(bot):
    ...
    outcomes = {
        ...
        7: f"{bot} rolled a 7/20 — it’ll go through, but probably not how {bot} intended.",
        8: f"{bot} rolled an 8/20 — you’ll get close, but no critical success for {bot}.",
        9: f"{bot} rolled a 9/20 — mediocre result incoming.",
